			...
			>
				...
				<View style={styles.formContainer}>
					...
					<View style={{flex: 1, alignItems: 'center', justifyContent: 'center', marginTop: 50}}>
						<Animated.Text entering={FadeInUp.delay(100).duration(1000).springify()} style={styles.title}>
							SignUp
						</Animated.Text>
					</View>
					{/* Form */}
					<View style={styles.form}>
						<Animated.View entering={FadeInDown.delay(100).duration(1000).springify()} style={{backgroundColor: 'rgba(0, 0, 0, 0.05)', padding: 20,borderRadius: 20, width: '100%'}}>
							<TextInput placeholder='Username' placeholderTextColor={'grey'} />
						</Animated.View>
						<Animated.View entering={FadeInDown.delay(200).duration(1000).springify()} style={{backgroundColor: 'rgba(0, 0, 0, 0.05)', padding: 20,borderRadius: 20, width: '100%'}}>
							<TextInput placeholder='Email' placeholderTextColor={'grey'} textContentType='oneTimeCode'/>
						</Animated.View>
						<Animated.View entering={FadeInDown.delay(400).duration(1000).springify()} style={{backgroundColor: 'rgba(0, 0, 0, 0.05)', padding: 20,borderRadius: 20, width: '100%', marginBottom: 8}}>
						...
						<Animated.View entering={FadeInDown.delay(800).duration(1000).springify()} style={{flexDirection: 'row', justifyContent: 'center'}}>
							...
							<TouchableOpacity onPress={() => navigation.push('Login')}>
								<Text style={{color: '#0D82BF'}}>Login</Text>
							</TouchableOpacity>
						</Animated.View>
					</View>
				</View>
